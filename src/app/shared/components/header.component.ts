      ...
      <div class="header__inner container">
        ...
        <nav class="header__nav" [class.header__nav--open]="menuOpen()" role="navigation" aria-label="Main navigation">
          ...
          <button
            ...
            (click)="theme.toggle()"
            [attr.aria-label]="theme.theme() === 'dark' ? 'Switch to sepia theme' : theme.theme() === 'sepia' ? 'Switch to light theme' : 'Switch to dark theme'"
            [attr.title]="theme.theme() === 'dark' ? 'Sepia mode' : theme.theme() === 'sepia' ? 'Light mode' : 'Dark mode'"
          >
            @if (theme.theme() === 'dark') {
